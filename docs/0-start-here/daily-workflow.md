...
3. Check `docs/1-current-state/current-priorities.md` and `docs/1-current-state/current-progress.md`.
4. Confirm branch is `dev` or a functional branch from `dev`.
